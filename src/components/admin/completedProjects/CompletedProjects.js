...
function CompletedProjects() {
  ...
  let loadData = async () => {
    try {
      let projectdatum = await axios.get(`${process.env.REACT_APP_API_URL}/completedprojects`);
                        ...
                        projectdata.map((project, i) => {
                          return (
                            <tr>
                              ...
                              <td><button type="button" onClick={() => navigate(`/home/completedprojects/viewproject/${project._id}/2`)} class="btn btn-success">View</button></td>
